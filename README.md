...
Checkout is a git command that lets you navigate between branches, checking out  makes sure the branch files is up to date with the version stored in a branch. 
